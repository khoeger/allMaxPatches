...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 808.0, 29.5, 22.0 ],
					"text" : "0.3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 95.0, 842.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 795.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 20.0, 838.0, 71.5, 22.0 ],
					"text" : "biquad~"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 151.0, 736.0, 256.0, 128.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 745.853851139545441, 1873.0, 94.0, 22.0 ],
					"text" : "normalize~ 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 745.853851139545441, 1837.0, 66.0, 22.0 ],
					"text" : "cycle~ 770"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 650.460291574398752, 1873.0, 94.0, 22.0 ],
					"text" : "normalize~ 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 650.460291574398752, 1837.0, 66.0, 22.0 ],
					"text" : "cycle~ 660"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 553.460291574398752, 1873.0, 94.0, 22.0 ],
					"text" : "normalize~ 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 553.460291574398752, 1837.0, 66.0, 22.0 ],
					"text" : "cycle~ 550"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 20.0, 873.121323525905609, 94.0, 22.0 ],
					"text" : "normalize~ 0.05"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 453.460291574398752, 1828.0, 66.0, 22.0 ],
					"text" : "cycle~ 440"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 509.620505213737488, 639.750134527683258, 49.04536013801885, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 548.0, 532.0, 417.0, 20.0 ],
					"text" : "Signal"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 548.0, 400.053666234016418, 417.0, 47.0 ],
					"text" : "Amplitude\n\n"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 548.0, 449.053666234016418, 417.0, 74.0 ],
					"text" : "dB\n\n\n\n"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 652.0, 98.0, 33.0 ],
					"text" : "filter highest\nfrequencies out"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 734.460291574398752, 520.053666234016418, 225.0, 175.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 786.460291574398752, 496.053666234016418, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 831.460291574398752, 454.053666234016418, 128.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 903.460291574398752, 408.053666234016418, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 745.853851139545441, 1923.089938521385193, 150.0, 87.0 ],
					"text" : "Max / Motu / APPE2\n\n3 - 1 - LL\n5 - 3 - UL\n7 - 5 - LR\n9 - 7 - UR"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 523.8275346159935, 1923.089938521385193, 73.026316523551941, 47.0 ],
					"text" : "Laptop: \n1 right, \n2 left"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 145.184201717376709, 691.756731033325195, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 123.611637830734253, 652.0, 72.0, 22.0 ],
					"text" : "lores~ 2000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1088.131585717201233, 582.0, 24.0, 24.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 437.5, 582.0, 237.0, 582.0, 237.0, 624.0, 159.611637830734253, 624.0 ],
					"order" : 1,
					"source" : [ "obj-171", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 133.111637830734253, 891.0, 954.111637830734253, 891.0 ],
					"order" : 1,
					"source" : [ "obj-174", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 133.111637830734253, 891.0, 1346.111637830734253, 891.0 ],
					"order" : 0,
					"source" : [ "obj-174", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 133.111637830734253, 686.069979548454285, 154.684201717376709, 686.069979548454285 ],
					"order" : 3,
					"source" : [ "obj-174", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 133.111637830734253, 891.0, 571.111637830734253, 891.0 ],
					"order" : 2,
					"source" : [ "obj-174", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1097.631585717201233, 572.0, 1097.631585717201233, 572.0 ],
					"order" : 0,
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 96.184201717376709, 435.0, 174.0, 435.0, 174.0, 480.0, 681.631585717201233, 480.0 ],
					"order" : 0,
					"source" : [ "obj-66", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 197.298240760962017, 480.0, 747.0, 480.0, 747.0, 513.0, 948.0, 513.0, 948.0, 510.0, 962.5, 510.0 ],
					"order" : 0,
					"source" : [ "obj-68", 0 ]
				}
